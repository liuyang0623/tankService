...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_auth.WechatLoginRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_interactions.CreateCommentRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/users/{id}/posts": {
            "get": {
                ...
                "summary": "Get published posts by user ID",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "User ID",
    ...
    "definitions": {
        "internal_auth.WechatLoginRequest": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "string"
        ...
        "internal_interactions.CreateCommentRequest": {
            "type": "object",
            "properties": {
                "content": {
                    "type": "string"
